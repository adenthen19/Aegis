...
export default function ProjectRowActions({
  ...
  return (
    <div className="flex items-center justify-end gap-1">
      ...
      <EditProject row={row} clients={clients} open={editOpen} onClose={() => setEditOpen(false)} />
      <ConfirmDialog
        open={confirmOpen}
        onClose={() => setConfirmOpen(false)}
        onConfirm={() => deleteProjectAction(row.project_id)}
        title="Delete project?"
        description={`This will permanently delete "${row.deliverable_name}".`}
